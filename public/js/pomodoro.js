...
function addTodo() {
            const title = document.getElementById("textareaID").value
                ...
                fetch("http://127.0.0.1:3000/todo/addpomodoro", requestOptions)
                ...
                .then(result => {
                  ...
                  if (inputVal.length > 0) {
                    let liTag = ` <li class="list pending" onclick="handleStatus(this)"><span>
                        ...
                        <img src="icons/pencil.png" onclick="editTask(this,'${result.result._id}')" width="20px" alt="">
                        <img  class="mx-2" src="icons/delete.png" onclick="deleteTask(this,'${result.result._id}')" width="20px" alt="">
                        </span>
                      </li>`;
...
fetch(`http://127.0.0.1:3000/todo/deletepomodoro/${id}`, requestOptions)
  .then(response => response.json())
  .then(result =>{
...
fetch(`http://127.0.0.1:3000/todo/updatepomodoro/${id}`, requestOptions)
  .then(response => response.json())
  .then(result =>{ 
...
function clearAll() {
  ...
  fetch(`http://127.0.0.1:3000/todo/deleteallpomodoro`, requestOptions)
    .then(response => response.json())
    .then(result =>{
      // let ele = e.parentNode.parentNode;
      // // console.log(ele)
...
fetch("http://127.0.0.1:3000/todo/getpomodoro", requestOptions)
  .then(response => response.json())
  .then(result =>{
      result.data.users.map((items)=>{
      let liTag = ` <li class="list pending" onclick="handleStatus(this)"><span>
      <input  type="checkbox" /></span>
      ${items.title}
      <span class="mx-2 right">
      <img src="icons/pencil.png" onclick="editTask(this,'${items._id}')" width="20px" alt="">
      <img  class="mx-2" src="icons/delete.png" onclick="deleteTask(this,'${items._id}')" width="20px" alt="">
      </span>
    </li>`;
